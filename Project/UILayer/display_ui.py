...
class Display_UI:
    ...
    def print_register_new_voyage(self, departure="", destination="", date1="", date2="", time1="", time2="", plane=""):
        ...
        print("[2]".rjust(15), " Date Departure: ".ljust(20), date1.ljust(35),"[4] ".rjust(15), "Date Departure: ".ljust(20), date2.ljust(35))
        print("[3]".rjust(15), " Time Departing: ".ljust(20), time1.ljust(35),"[5] ".rjust(15), "Time Departing: ".ljust(20), time2.ljust(35))
